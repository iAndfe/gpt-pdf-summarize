...
b. **Virtual Environment Method**: Alternatively, on main.ipynb click `Select Kernel`, and build a new .venv (python virtual environment) and tick install requirements.txt on venv creation.
